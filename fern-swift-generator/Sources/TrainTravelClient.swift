...
public final class TrainTravelClient: Sendable {
    public let stations: StationsClient
    public let trips: TripsClient
    public let bookings: BookingsClient
    ...
    public convenience init(
        baseURL: String = TrainTravelEnvironment.production.rawValue,
        token: String? = nil,
    ...
    init(
        ...
        self.stations = StationsClient(config: config)
        self.trips = TripsClient(config: config)
        self.bookings = BookingsClient(config: config)
