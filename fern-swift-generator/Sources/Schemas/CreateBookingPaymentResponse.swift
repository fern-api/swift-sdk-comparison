...
public struct CreateBookingPaymentResponse: Codable, Hashable, Sendable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.links = try container.decodeIfPresent(LinksBooking.self, forKey: .links)
