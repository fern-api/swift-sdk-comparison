...
public struct NewBookingPayload: Codable, Hashable, Sendable {
    ...
    public let links: NewBookingPayloadLinks?
    ...
    public init(
        ...
        hasBicycle: Bool? = nil,
        hasDog: Bool? = nil,
        links: NewBookingPayloadLinks? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.links = try container.decodeIfPresent(NewBookingPayloadLinks.self, forKey: .links)
